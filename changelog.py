"""
changelog.py — история изменений Mission Analyzer. Показывается на
странице «Довідка» (Help), отдельной вкладкой. Новые записи добавляй
в начало списка ENTRIES при значимых обновлениях — заодно поправь
version.VERSION.
"""
